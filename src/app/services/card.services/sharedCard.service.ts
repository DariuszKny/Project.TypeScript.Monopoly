...
export const payMoneyToCardOwner = (
  player: Player,
  owner: Player,
  money: number,
): void => {
  ...
  logMessage(
    Messages.playerPaidMoneyToOwner(
      player,
      owner,
      money,
      priceDiscount,
...
export const numberOfOwnedCards = (
  player: Player,
  cards: number[],
): number => {
