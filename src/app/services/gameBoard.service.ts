...
export const gameBoard: gameField[] = [
  ...
  },
  {
    card: new FateCard(
      3,
      'Good',
      'If you are good champion wait for reward',
    ),
  ...
  },
  {
    card: new FateCard(
      13,
      'Evil',
      'If you are bad champion wait for reward',
    ),
  ...
  },
  {
    card: new CityCard(
      26,
      'Fangorn Forest',
      'Province: Calenardhon',
      460,
      Province.CALENARDHON,
      rent.FARGORN_FOREST_RENT,
    ),
    action: [payRent, buyHouse],
  },
  {
  ...
  },
  {
    card: new TrapCard(
      37,
      "Spider's Lair",
      'You are attacked by spider you have to go back',
    ),
