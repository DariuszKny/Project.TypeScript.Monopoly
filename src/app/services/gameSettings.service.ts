...
import disableEnable = Disabler.disableEnable;
    export let nameChoose = function (navigationPages: NavigationPagesView, settings: { id:number,name:string}[]) {
    let name1 = document.getElementById("player0")! as HTMLInputElement;
    let name2 = document.getElementById("player1")! as HTMLInputElement;
    let name3 = document.getElementById("player2")! as HTMLInputElement;
    let name4 = document.getElementById("player3")! as HTMLInputElement;
...
export let timeChoose = function (settings : {players:{id: number,name:string}[], time:number}, navigationPages: NavigationPagesView, button: Element) {
...
export let championChoose = function (champ: Element, gameOptionView: GameOptionView, settings : {players:{id: number,name:string,champ:Hero,isGood:boolean}[], time:number}) {

    let d = document.querySelector(".champion-container")! as HTMLElement;
    ...
    if(currentChooser==settings.players.length) {
        ...
        disableEnable([],[document.getElementById("buttonPlay")! as HTMLButtonElement])
    }
